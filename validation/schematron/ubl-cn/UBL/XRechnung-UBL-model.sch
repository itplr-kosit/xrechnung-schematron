<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model"
    ...
    <param name="BR-DE-7"
        value="cbc:ElectronicMail[boolean(normalize-space(.))]" />
    ...
    <param name="BR-DE-15"
        value="cbc:BuyerReference[boolean(normalize-space(.))]" />
    <param name="BR-DE-16"
    ...
    <param name="BR-DE-17"
        value="cbc:CreditNoteTypeCode = ('326', '380', '384', '389', '381')" />
    <param name="BR-DE-18"
    ...
    <param name="BR-DE-20"
        value="         not(cbc:PaymentMeansCode = '59') or          matches(cac:PayeeFinancialAccount/cbc:ID, '^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{0,30}$') and          xs:integer(         replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(         upper-case(concat(substring(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID,5),substring(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID,1,4)))         ,'A','10'),'B','11'),'C','12'),'D','13'),'E','14'),'F','15'),'G','16'),'H','17'),'I','18'),'J','19'),'K','20'),'L','21'),'M','22')         ,'N','23'),'O','24'),'P','25'),'Q','26'),'R','27'),'S','28'),'T','29'),'U','30'),'V','31'),'W','32'),'X','33'),'Y','34'),'Z','35')         ) mod 97 = 1" />
    <param name="BR-DE-21"
    ...
    <param name="BG-4_SELLER"
        value="//ubl:CreditNote/cac:AccountingSupplierParty" />
