<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model"
  ...
  <param name="BR-DE-19"
    value="         not(cbc:PaymentMeansCode = '58') or          matches(normalize-space(replace(replace(replace(replace(replace(cac:PayeeFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')), '^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{0,30}$') and          xs:integer(         replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(         upper-case(concat(substring(normalize-space(replace(replace(replace(replace(replace(cac:PayeeFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')),5),substring(normalize-space(replace(replace(replace(replace(replace(cac:PayeeFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')),1,4)))         ,'A','10'),'B','11'),'C','12'),'D','13'),'E','14'),'F','15'),'G','16'),'H','17'),'I','18'),'J','19'),'K','20'),'L','21'),'M','22')         ,'N','23'),'O','24'),'P','25'),'Q','26'),'R','27'),'S','28'),'T','29'),'U','30'),'V','31'),'W','32'),'X','33'),'Y','34'),'Z','35')         ) mod 97 = 1         " />
  <param name="BR-DE-20"
    value="         not(cbc:PaymentMeansCode = '59') or          matches(normalize-space(replace(replace(replace(replace(replace(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')), '^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{0,30}$') and          xs:integer(         replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(         upper-case(concat(substring(normalize-space(replace(replace(replace(replace(replace(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')),5),substring(normalize-space(replace(replace(replace(replace(replace(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID, ' ', '', 'm') , '\n ', ''), '\r ', '', 'm'), '\t ', '', 'm'), '\s ', '', 'm')),1,4)))         ,'A','10'),'B','11'),'C','12'),'D','13'),'E','14'),'F','15'),'G','16'),'H','17'),'I','18'),'J','19'),'K','20'),'L','21'),'M','22')         ,'N','23'),'O','24'),'P','25'),'Q','26'),'R','27'),'S','28'),'T','29'),'U','30'),'V','31'),'W','32'),'X','33'),'Y','34'),'Z','35')         ) mod 97 = 1" />
  <param name="BR-DE-21"
