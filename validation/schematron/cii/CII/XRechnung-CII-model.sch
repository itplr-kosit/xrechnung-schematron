<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="CII-model">
    ...
    <param name="BR-DE-3" value="boolean(normalize-space(ram:CityName))"/>
    <param name="BR-DE-4" value="boolean(normalize-space(ram:PostcodeCode))"/>
    <param name="BR-DE-5" value="(ram:PersonName,ram:DepartmentName)[boolean(normalize-space(.))]"/>
    <param name="BR-DE-6" value="boolean(normalize-space(ram:TelephoneUniversalCommunication/ram:CompleteNumber))"/>
    <param name="BR-DE-7" value="boolean(normalize-space(ram:EmailURIUniversalCommunication/ram:URIID))"/>
    <param name="BR-DE-8" value="boolean(normalize-space(ram:CityName))"/>
    <param name="BR-DE-9" value="boolean(normalize-space(ram:PostcodeCode))"/>
    <param name="BR-DE-10" value="boolean(normalize-space(ram:CityName))"/>
    <param name="BR-DE-11" value="boolean(normalize-space(ram:PostcodeCode))"/>
    ...
    <param name="BR-DE-14" value="boolean(normalize-space(ram:RateApplicablePercent))"/>
    <param name="BR-DE-15" value="boolean(normalize-space(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerReference))"/>
    <param name="BR-DE-16" value="(boolean(normalize-space(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration/ram:ID[@schemeID='VA' or @schemeID='FC'])), rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTaxRepresentativeTradeParty)"/>
    <param name="BR-DE-17" value="rsm:ExchangedDocument/ram:TypeCode = ('326', '380', '384', '381')"/>
