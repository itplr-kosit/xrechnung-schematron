<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="model">
    <rule context="$INVOICE">
        ...
        <assert test="$BR-DE-16" flag="fatal" id="BR-DE-16">[BR-DE-16] Das Element "Seller VAT identifier" (BT-31) muss übermittelt werden, wenn nicht das Element "Seller tax registration identifier" (BT-32) oder eine Gruppe "SELLER TAX REPRESENTATIVE PARTY" (BG-11) übermittelt wurden.</assert>
